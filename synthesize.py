...
from utils.model import get_model, get_vocoder, test_model
from utils.tools import to_device, synth_samples, calc_diffusion_hyperparams
...
def synthesize(model, step, configs, vocoder, batchs, control_values, diffusion_hyperparams):
    ...
    for batch in batchs:
        ...
        with torch.no_grad():
            output, batch = test_model(batch, model, configs, diffusion_hyperparams, pitch_control, energy_control, duration_control)
            synth_samples(
                batch,
                output,
                vocoder,
...
if __name__ == "__main__":
    ...
    synthesize(model, args.restore_step, configs, vocoder, batchs, control_values, diffusion_hyperparams)
