...
class FastSpeech2_MI3(nn.Module):
    """ FastSpeech2 """

    def __init__(self, preprocess_config, model_config):
        super(FastSpeech2_MI3, self).__init__()
        ...
        self.concat_linear = nn.Linear(
            model_config["transformer"]["decoder_hidden"] * 2,
            model_config["transformer"]["decoder_hidden"]
        )
        self.dropout_1 = nn.Dropout(p=model_config["dropout_rate"])
        self.decoder = Decoder(model_config)
        self.dropout_2 = nn.Dropout(p=model_config["dropout_rate"])
    ...
    def forward(
        ...
        origin_transformed_X = transformed_X
        ...
        transformed_X = self.conv_2(transformed_X)
